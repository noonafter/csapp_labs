...
0000000000400da0 <main>:
  ...
  400dd8:	48 8b 4b 08          	mov    0x8(%rbx),%rcx             # 否则，打印退出。printf_chk的第4个参数，argv[1]
  ...
  400df8:	48 8b 16             	mov    (%rsi),%rdx                # argc不等于2，打印退出。printf_chk的第3个参数，(%rsi)是argv[0]（rsi是argv，argc不等于1也不等于2，打印后退出）
  400dfb:	be d3 22 40 00       	mov    $0x4022d3,%esi             # printf_chk的第2个参数，0x4022d3应该是格式化字符串的首地址，但不知道为什么要放在第二个参数？
  400e00:	bf 01 00 00 00       	mov    $0x1,%edi                  # printf_chk的第1个参数，固定位1
